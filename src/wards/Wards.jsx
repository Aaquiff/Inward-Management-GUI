...
export default class Wards extends Component {
    ...
    render() {
        ...
        return <div className="row">
                <div className="col-4">
                    <ListWards deleteWard={ward => this.deleteWard(ward)} onView={ward => this.onView(ward)}
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="form-group">
                                ...
                                <button type="button" className="btn btn-dark" data-toggle="modal"
                                        data-target="#exampleModal">New Ward
                                </button>
                            </div>
                            {/*Start of modal*/}
                        ...
                        <div className="row">
                            <Ward ward={this.state.ward} beds={this.state.beds} deleteWard={ward => this.deleteWard(ward)}
                                  addBed={bed => this.addBed(bed)} deleteBed={bed => this.deleteBed(bed)}/>
                        </div>
                    </div>
                </div>
            </div>
